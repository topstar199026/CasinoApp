...
Route::namespace('User')
    ->prefix('user')
    ->middleware(['cookies', 'auth:sanctum', 'maintenance', 'verified', 'active', '2fa'])
    ->group(function () {
        // user profile
...
Route::middleware(['cookies', 'auth:sanctum', 'maintenance', 'verified', 'active', '2fa'])
    ->group(function () {
        // users
        ...
        // leaderboard
        Route::get('leaderboard', 'LeaderboardController@index')->middleware('page.enabled');
        // chat
...
Route::namespace('Admin')
    ->prefix('admin')
    ->middleware(['cookies', 'auth:sanctum', 'verified', 'active', '2fa', 'role:' . App\Models\User::ROLE_ADMIN])
    ->group(function () {
        // dashboard
        ...
        Route::patch('files/{name}', 'FileController@update');
        // maintenance
