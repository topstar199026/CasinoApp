                        ...
                        <v-expansion-panels>
                          ...
                          >
                            ...
                            <v-expansion-panel-content>
                              ...
                              <v-btn color="error" @click="form.CONTENT_FOOTER_MENU.splice(i, 1)">
                                {{ $t('Delete menu item') }}
                              </v-btn>
                            </v-expansion-panel-content>
                          </v-expansion-panel>
...
export default {
  ...
  created () {
    Object.keys(this.packages).forEach(async packageId => {
      try {
        const module = await import(/* webpackChunkName: 'js/packages/[request]' */ `packages/${packageId}/resources/js/pages/admin/settings`)
